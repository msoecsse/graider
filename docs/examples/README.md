...
- `course.yml`: course-level defaults and GitHub settings
- `term.yml`: term identity and section roster paths
- `assignment.yml`: one assignment using a GitHub template repository
...
Copy these into a sandbox course-admin repository and update organization, repository, team, user, and assignment values before running live GitHub commands.
