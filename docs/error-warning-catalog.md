...
| `grading_workflow_missing`                 | error    | Configured workflow was not found.                         | `1`               | Add/fix workflow path.                                                       |
| `workflow_dispatch_unsupported`            | error    | Workflow lacks dispatch support.                           | `1`               | Add `workflow_dispatch`.                                                     |
...
| `grading_not_configured`                   | error    | Assignment has no grading workflow.                        | `1`               | Enable grading or skip grade/report expectations.                            |
